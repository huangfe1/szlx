...
<header
    ...
    <%--<img src="<c:url value='/resources/images/mall-logo.png'/>"--%>
    <%--class="logo-img">--%>
</header>
...
<div class="container" id="nav">
    ...
    <span style="color:red;font-size: 1.2em">精彩推荐:</span><span
        style="color: #00aba9;margin-left: 2em">食在乐享正式上线,赶紧抢购!!!</span>
</div>
...
<script type="text/javascript">
    $(function () {
        ...
        $("#products").delegate(".detailBtn", "click", function (e) {
            ...
            e.stopPropagation();
            var id = $(this).attr("data-id");
            window.location = "<c:url value='/dmz/vmall/detail.html'/>" + "?id=" + id + "&&ref=${agentCode}";
        });
