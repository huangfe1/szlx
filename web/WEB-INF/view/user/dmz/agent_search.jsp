...
<body style="background:white;">
	...
	<div class="container-fluid">
				...
				<form role="form" class="form-horizontal"
					...
					<div class="form-group input-group">
						<input type="search" name="entity.agentCode" id="agentCode"
							...
							class="form-control input-lg" placeholder="请输入代理编码/微信/手机进行查询"
		...
		<c:if test="${ (empty agent  or empty auths) and empty f}">
			<div class="row">
				<div class="col-md-12 col-sm-12 col-xs-12">
					<div class="alert alert-warning text-center" role="alert">未查询到此信息对应代理的授权</div>
				</div>
			</div>
		</c:if>
		<c:if test="${ ! empty agent}">
            ...
            <div align="center">
				<img  class="letter" src="<c:url value='/auth/dmz/letterimg/${agent.agentCode}.html'><c:param name='id' value='${auth.id}'/></c:url>">
            </div>
			</c:forEach>
			<%--<div class="row">--%>
				<%--<div class="col-md-12   col-sm-12 col-xs-12">--%>
