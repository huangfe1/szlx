	...
	<form action="<c:url value='/advance/transfer.json'/>"
		...
		<div class="modal-content">
			<div class="modal-header">
				...
				<span class="glyphicon glyphicon-retweet"></span>代理物流费转账</h4>
			</div>
							...
							<div class="panel panel-primary">
								...
								<div class="panel-body">
									...
									<div class="form-group">
										...
										<div class="col-sm-4">
											<input type="text" class="form-control" required
												...
												placeholder="输入接受物流费的代理编号">
										</div>
										<div class="col-md-4 col-xs-4 text-error"></div>
									</div>
									<input type="hidden" value="0" name="useVoucher">
									<div class="form-group">
										<label for="currentStock" class="col-sm-2 control-label">转出物流费数量</label>
										<div class="col-sm-4">
									...
									<div class="form-group">
										...
										<textarea class="form-control" rows="4" name="remark" tabindex="13">公司转出物流费</textarea>
										</div>
									</div>
								</div>
							</div>
					...
					<div class="form-group">
						...
						<div class="col-md-6 col-xs-12">
							<button type="submit" class="btn btn-success btn-block"
								...
								<span class="glyphicon glyphicon-random">&nbsp;</span>转物流费给代理
							</button>
						</div>
					</div>
				</div>
