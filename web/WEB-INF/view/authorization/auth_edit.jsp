	...
	<div class="modal-content">
		...
		<div class="modal-body">
			<div class="container-fluid">
				<form action="<c:url value='/auth/active.json'/>" name="editForm"
							...
							<div class="panel panel-primary">
								...
								<div class="panel-body">
									...
									<div class="form-group">
										<label for="currentBalance" class="col-sm-2 control-label">申请人编号</label>
										<div class="col-sm-6">
                                            <p class="form-control-static">${parameter.entity.agent.agentCode}</p>
										</div>
									</div>

                                    <div class="form-group">
                                        <label for="currentBalance" class="col-sm-2 control-label">申请人姓名</label>
                                        <div class="col-sm-6">
                                            <p class="form-control-static">${parameter.entity.agent.realName}</p>
                                        </div>
                                    </div>
									...
									<div class="form-group">
										<label for="editOrder" class="col-sm-2 control-label">授权等级</label>
										<div class="col-sm-4">
                                            <p class="form-control-static">${levels[parameter.entity.authorizationType.goods.id].agentLevel.name}</p>
										</div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-4">
                                            <p class="form-control-static">${parameter.entity.authorizationType.goods.name}</p>
                                        </div>
                                        <div class="col-md-4 col-xs-4 text-error"></div>
                                    </div>
									<!-- </form>-->
