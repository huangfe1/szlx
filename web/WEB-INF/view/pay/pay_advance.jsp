   ...
   WeixinJSBridge.invoke(
       ...
       function(res){
           if(res.err_msg == "get_brand_wcpay_request:ok" ) {
        	   alert("物流费充值功");
        	   $("#winMessageBody").empty().html("<h4>物流费充值成功,系统将回到商城首页</h4>").addClass("text-primary");
...
<div class="jumbotron">
		...
		<div class="row">
			<div class="col-xs-12">
			<h4 class="text-warning">你正在与湖南食在乐享进行微信支付,请核对订单金额完成支付</h4>
		...
		<div class="modal-dialog modal-lg" role="document">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title" id="winModalLabel">食在乐享物流费充值</h4>
				</div>
