...
<div class="container-fluid">
	...
	<div class="row">
		<div class="col-md-12 col-xs-12">
			...
			<h5 class="text-danger">0元购:<span class="fa fa-rmb"></span><strong>${goods.moneyPrice}物流费</strong></h5>
			<h5 class="text-danger">分享可获得:<span class="fa fa-rmb"></span><strong>1-2元广告费</strong></h5>
		</div>
					...
					if(xhr.status>=200 && xhr.status<300){
						...
						if(m.flag=="0"){
							...
							window.setTimeout(function() {
								window.location.href="<c:url value='/pmall/shopcart/index.html?ref=${agentCode}'/>";
							}, 1000);
