...
<div class="container">
	...
	<div class="container">
		<div class="row" id="products">
			<div class="col-md-12 col-xs-12">
				...
				<table class="table">
					<thead>
						<tr>
							<th>商品</th><th>单价</th><th>积分价</th><th>数量</th><th>金额</th>
							<th>所需积分</th>
							<th>操作</th>
						</tr>
					</thead>
		...
		<div class="row">
			<div class="col-md-12 col-xs-12">
				<a class="btn btn-warning btn-lg btn-block" href="<c:url value='/pmall/shopcart/settlement.html?ref=${agentCode}'/>" id="payBtn" <c:if test="${ empty pmshopcart or pmshopcart.quantity<1}">disabled='disabled'</c:if> >
				<span class="glyphicon glyphicon-credit-card"></span>去结算</a>
			</div>
		</div>
		<br>
		...
		<div class="row">
			<div class="col-md-12 col-xs-12">
				<a class="btn btn-info btn-lg btn-block" href="<c:url value='/dmz/pmall/index.html?ref=${agentCode}'/>">
