	...
	<div class="row">
        ...
        <div class="col-xs-3">
            <a class="thumbnail" href="<c:url value='/dmz/pmall/index.html?ref=${agentCode}'/>"> <img data-src="" alt=""
                                                                                                      ...
                                                                                                      data-holder-rendered="true">
                <div class="caption">
                    <h6 class="text-center">健康养生区</h6>
                </div>
            </a>
        </div>
		<div class="col-xs-3">
			<a class="thumbnail"
			   href="<c:url value='/pmall/shopcart/index.html?ref=${agentCode}'/>"> <img
					data-src="" alt=""
					...
					function(datas) {
						...
						datas.forEach(function(data,i) {
							...
							/* var template = '<div class="col-md-6 col-xs-6 productItem">'
							 + '<div class="thumbnail buyBtn" data-id='+data.id+'><img data-src="" alt=""	src="'+data.imgUrl+'"'+
							 ' data-holder-rendered="true" class="product_img"><div class="caption">'
							 + '<h6 class="text-center title"><strong>'
							 + data.name
							 +'</strong>&nbsp;'
							 +data.spec
							 + '</h6>'
...
//														'<h6><span class="fa fa-rmb"></span>'+data.moneyPrice+'+'+data.pointPrice+'积分</h6>'+
									'<h6><span class="fa fa-rmb">秒杀价:0元,</span>'+data.moneyPrice+'物流费</h6>'+
									...
									'><span class="fa fa-shopping-cart fa-2x"></span></a></h6></div>';
		...
		$("#products").delegate(".detailBtn", "click", function(e) {
			...
			e.stopPropagation();
			var id=$(this).attr("data-id");
			window.location="<c:url value='/dmz/pmall/detail.html'/>"+"?id="+id+"&&ref="+${agentCode};
		});
