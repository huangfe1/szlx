				...
				<div class="row">
					...
					<div class="panel panel-primary">
						...
						<div class="form-group" >
								...
								<div class="col-sm-6">
								<c:forEach items="${types}" var="type" step="2">
									 <label class="checkbox-inline">
    			  						<input required checked  type="radio" name="goodsType" id="goodsType" value="${type}"  ${parameter.entity.goodsType eq  type ? 'checked' : ''} >
        					 				 ${type.desc}
        							 </label>
   								</c:forEach>
								</div>
							...
							<div class="form-group">
								...
								<div class="form-group" style="display: none">
									...
									<div class="col-sm-4">
                                        <div id="demo">
                                            <c:forEach items="${fn:split(parameter.entity.detailImg,'+')}" var="val" varStatus="i" >
                                                <div id="uploadedList_${i.index}" class="upload_append_list" >
                                                    <div class="file_bar">
                                                        <div style="padding:5px;"><p class="file_name">${val}</p><span class="file_del" data-index="0" title="删除"></span>
                                                        </div>
                                                    </div>
                                                    <a style="height:100px;width:120px;" href="#" class="imgBox">
                                                        <div class="uploadImg" style="width:105px"><img id="uploadImage_0" class="upload_image" src="<%=request.getContextPath()%>/dmz/img/goods/${val}"
							...
							<!-- 返利模式 -->
							<div class="form-group">
								<label for="pointFactor" class="col-sm-2 control-label">返利模式</label>
								<div class="col-sm-4">
								...
								<tbody>
									<c:forEach var="l" items="${levels}" varStatus="s">
										...
										<tr class="lc" tag="${l.goodsType}">
											...
											<%--<td><input   type="number" name="levelPrice" tabindex="${s.count+18}"  value="1" ></td>--%>
											<%--<td><input   type="number" name="levelThreshold" tabindex="${s.count+19}" value="1"></td>--%>
