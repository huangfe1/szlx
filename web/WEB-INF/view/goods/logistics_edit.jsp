                            ...
                            <div class="panel panel-primary">
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="form-group">
                                        <label for="provinces" class="col-sm-2 control-label">仓库名字</label>
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control" id="name" tabIndex="10"
                                    ...
                                    <!-- 重量区间 -->
                                    <div class="form-group">
                                        <label for="weights" class="col-sm-2 control-label">仓库描述</label>
                                        <div class="col-sm-8">
                                    ...
                                    <!-- 价格区间 -->
                                    <div class="form-group">
                                        <label for="prices" class="col-sm-2 control-label">价格规则</label>
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control" id="prices" tabIndex="13"
                                                   name="prices" value="${parameter.entity.prices}"
                                                   placeholder="如4_3或者4  前者表示第一个收4元,每增加一个收3元。后者表示每一个货物收4元">
                                        </div>
                                        <div class="col-md-4 col-xs-4 text-error"></div>
                                    </div>
                                    ...
                                    <!-- 库存 -->
                                    <div class="form-group">
                                        <label for="prices" class="col-sm-2 control-label">库存</label>
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control" id="balance" tabIndex="13"
                                                   name="balance" value="${parameter.entity.balance}"
                                                   placeholder="">
                                        </div>
                                        <div class="col-md-4 col-xs-4 text-error"></div>
                                    </div>
                                    ...
                                    <!-- 排序 -->
                                    <div class="form-group">
                                        <label for="prices" class="col-sm-2 control-label">排序</label>
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control" id="orderIndex" tabIndex="13"
                                                   name="orderIndex" value="${parameter.entity.orderIndex}"
                                                   placeholder="数字最小,越靠前">
                                        </div>
                                        <div class="col-md-4 col-xs-4 text-error"></div>
                                    </div>
