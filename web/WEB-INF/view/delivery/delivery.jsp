					...
					<form action="<c:url value='/delivery/delivery.json'/>"
						...
						<div class="panel panel-primary">
							...
							<div class="panel-body">
								...
								<div class="form-group">
									<div class="col-sm-12">
										<select  type="text" class="form-control" id="logist" name="sfgzId">
											<c:forEach items="${ls}" var="l">
												<option <c:if test="${l.id eq parameter.entity.sfgz.id}"> selected</c:if> value="${l.id}">${l.name}/${l.weights}/${l.provinces}</option>
											</c:forEach>
										</select>
