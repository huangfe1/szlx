			...
			<div class="container-fluid">
				...
				<form class="navbar-form navbar-left" id="searchForm"
					...
					<div class="form-group">
						...
						<label class="">库房</label>
						<select name="entity.sfgz.weights" id="status" class="form-control">
							<option value="">所有</option>
							<c:forEach items="${logisticses}" var="log">
								<option value="${log}" <c:if test="${parameter.entity.sfgz.weights==log}">selected</c:if>>
										${log}</option>
							</c:forEach>
						</select>
