...
<nav class="navbar navbar-inverse navbar-static-top" role="navigation"
	...
	<div class="navbar-header">
		...
		<p class="navbar-text">食在乐享管理信息系统</p>
	</div>
	<!-- /.navbar-header -->
	<div class="collapse navbar-collapse menu-navbar-collapse" id="menu-navbar-collapse">
			<ul class="nav navbar-nav">
				...
				<c:when test="${user.agent}">
					...
					<%--<li><p class="navbar-text">奖金:<span id="voucherBalance">${accounts.voucherBalance}</span></p></li>--%>
				...
				<c:when test="${user.admin}">
					<%--<li><p class="navbar-text">公司账户奖金余额:<span id="voucherBalance">${accounts.voucherBalance}</span></p></li>--%>
				</c:when>
				</c:choose>
			</ul>
					...
					<li><a href="#" class="menuitem"><i
						...
						<ul class="nav nav-second-level">
							...
							<li><a
									...
									class="fa fa-money fa-fw"></i>转物流费记录<span class="fa arrow"></span></a></li>
							...
							<li><a
									...
									class="fa fa-money fa-fw"></i>物流费详情<span class="fa arrow"></span></a></li>
