...
public class VoucherWXPayController{
	...
	public String pay(@RequestParam(required = false)String code,Integer orderId,Model model,HttpServletRequest request){
		try {
            ...
            String notifyUrl =payConfig.getNotifVoucherUrl();//物流费充值
            UnifiedOrderResData unifiedOrder = unifiedOrderHandler.unifiedOrder(notifyUrl, voucherTransfer.getOut_trade_no(), voucherTransfer.getVoucher(), payConfig, agent, "食在乐享奖金充值");
