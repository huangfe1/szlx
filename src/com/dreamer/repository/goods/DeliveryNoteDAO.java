...
public class DeliveryNoteDAO extends HibernateBaseDAO<DeliveryNote> {
	...
	public List<DeliveryNote> findDownload(SearchParameter<DeliveryNote> t){
        ...
        Logistics sfgz=t.getEntity().getSfgz();
        if(Objects.nonNull(sfgz)&&Objects.nonNull(sfgz.getWeights())&&!sfgz.getWeights().equals("")){
            criteria.createCriteria("sfgz").add(Restrictions.eq("weights",sfgz.getWeights()));
